...
from pymtl.passes.rtlir.translation.behavioral import BehavioralUpblkTrans

class SVBehavioralUpblkTrans( BehavioralUpblkTrans ):
  ...
  def rtlir_tr_upblk_decl( m, upblk, rtlir_upblk ):
    visitor = UpblkRTLIRToSVVisitor( m )
