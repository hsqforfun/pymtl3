...
def local_do_test( m ):
  ...
  # m._test_vector[0] = pymtl_name( m._test_vector[0] )
...
@pytest.mark.xfail( reason = 'RegEn uses deepcopy' )
def test_bypass_queue( do_test ):
  from pclib.rtl.valrdy_queues import BypassQueue1RTL

  m = BypassQueue1RTL( Bits32 )
  m._test_vector = [
      'enq.val   enq.msg   deq.rdy   *enq.rdy    *deq.msg   *deq.val',
    [   Bits1,   Bits32,    Bits1,     Bits1,     Bits32,      Bits1 ],
